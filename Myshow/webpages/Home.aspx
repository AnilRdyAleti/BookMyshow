<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Myshow.Home" %>
...
.a1{
    font-size:12px;color:white;text-decoration:none;padding:3px;padding-bottom:5px;
}
        .a1:hover {
...
#a4{
   margin-top:200px;
            margin-left:289px;height:35px;width:120px;background-color:red;border-color:red;border-radius:5px;position:fixed;
}
         </style>
</head>
<body>
    ...
    <div>
        <div id="a1"><a href="#" >
        <img src="../Images/home.png" width="25" height="25" class="a1" /></a>
        ...
        <a class="a1" href="#popup1" >SIGN IN</a></div>
...
<label typeof="label" style="width:50px;height:50px;float:right;margin:20px"><a style="text-decoration:none;" href="https://accounts.google.com/ServiceLogin?service=mail&passive=true&rm=false&continue=https://mail.google.com/mail/&ss=1&scc=1&ltmpl=default&ltmplcache=2&emr=1&osid=1">Gmail</a>
        ...
        <div><input list="ALL" id="a4" value="ALL" /><datalist id="ALL">
           <option value="MOVIES">MOVIES</option>
           <option value="EVENTS">EVENTS</option>
           <option value="PALYS">PLAYS</option>
           <option value="SPORTS">SPORTS</option>

            </datalist></div>
    
    <div><img src="/Images/kaththi.jpg" id="a3" onclick="changeImage()" /></div>
        
    <div style="text-align:center;margin:30px;"><b>FEATURED EVENTS</b></div>

    <div>
        <img class="a3" src="/Images/images.jpg" />
        <img class="a3" src="/Images/images%20(1).jpg" />
        <img class="a3" src="/Images/images%20(2).jpg" />
        <img class="a3" src="/Images/images%20(3).jpg" />
        <img class="a3" src="/Images/images%20(4).jpg" />
        <img class="a3" src="/Images/images%20(5).jpg" />
        <img class="a3" src="/Images/images%20(6).jpg" />
        <img class="a3" src="/Images/images%20(7).jpg" />
    </div>
